...
while IFS=";" read -r titlealt contentalt ticketIdalt;do
    if [ "$ticketId" == "$ticketIdalt" ]; then
        sed -i "s/$titlealt/$title/g" /home/docker-step2023-team-06/data/swe1-project/live.csv
        sed -i "s/$contentalt/$content/g" /home/docker-step2023-team-06/data/swe1-project/live.csv
    fi
