...
id=$(cat /home/docker-step2023-team-06/data/swe1-project/id-intest.int)

echo "$title;$content;$(($id + 1))" >> /home/docker-step2023-team-06/data/swe1-project/intest.csv
echo $(($id + 1)) > /home/docker-step2023-team-06/data/swe1-project/id-intest.int
