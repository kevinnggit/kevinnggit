...
id=$(cat /home/docker-step2023-team-06/data/swe1-project/id-inprogress.int)

echo "$title;$content;$(($id + 1))" >> /home/docker-step2023-team-06/data/swe1-project/inprogress.csv
echo $(($id + 1)) > /home/docker-step2023-team-06/data/swe1-project/id-inprogress.int
